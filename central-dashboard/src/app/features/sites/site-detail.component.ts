      ...
      <div class="info-grid">
        ...
        <div class="card">
          ...
          <div class="metrics-grid" *ngIf="currentMetrics; else noMetrics">
            <div class="metric" [class.warning]="currentMetrics.cpu_usage > 80">
              ...
              <div class="metric-bar">
                <div class="metric-fill" [style.width.%]="currentMetrics.cpu_usage"></div>
              </div>
            </div>

            <div class="metric" [class.warning]="currentMetrics.memory_usage > 80">
              <div class="metric-icon">🧠</div>
              <div class="metric-info">
              ...
              <div class="metric-bar">
                <div class="metric-fill" [style.width.%]="currentMetrics.memory_usage"></div>
              </div>
            </div>

            <div class="metric" [class.warning]="currentMetrics.temperature > 70" [class.critical]="currentMetrics.temperature > 80">
              ...
              <div class="metric-bar">
                <div class="metric-fill" [style.width.%]="Math.min(currentMetrics.temperature, 100)"></div>
              </div>
            </div>

            <div class="metric" [class.warning]="currentMetrics.disk_usage > 80" [class.critical]="currentMetrics.disk_usage > 90">
              <div class="metric-icon">💾</div>
              <div class="metric-info">
