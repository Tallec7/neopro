...
echo "     # Sauvegarder configuration et videos"
echo "     cp webapp/configuration.json /tmp/configuration.json.bak"
echo "     mv webapp/videos /tmp/videos.bak 2>/dev/null || true"
...
echo "     # Restaurer configuration et videos"
echo "     sudo cp /tmp/configuration.json.bak webapp/configuration.json"
echo "     sudo mv /tmp/videos.bak webapp/videos 2>/dev/null || true"
